...
public class ModBlocks {
    ...
    public static class Pillars{
        ...
        public static final Block DRIED_KELP_PILLAR = registerBlock("dried_kelp_pillar",
                PillarBlock::new, (Settings.copy(Blocks.DRIED_KELP_BLOCK)));
        ...
        public static final Block ANCIENT_DEBRIS_PILLAR = registerBlock("ancient_debris_pillar",
                PillarBlock::new, (Settings.copy(Blocks.ANCIENT_DEBRIS)));
        ...
        public static final Block GLASS_PILLAR = registerBlock("glass_pillar",
                PillarGlassBlock::new, (Settings.copy(Blocks.GLASS)));
        public static final Block TINTED_GLASS_PILLAR = registerBlock("tinted_glass_pillar",
                PillarTintedGlassBlock::new, (Settings.copy(Blocks.TINTED_GLASS)));
        ...
        public static final Block RAW_IRON_PILLAR = registerBlock("raw_iron_pillar",
                PillarBlock::new, (Settings.copy(Blocks.RAW_IRON_BLOCK)));
        public static final Block RAW_COPPER_PILLAR = registerBlock("raw_copper_pillar",
                PillarBlock::new, (Settings.copy(Blocks.RAW_COPPER_BLOCK)));
        public static final Block RAW_GOLD_PILLAR = registerBlock("raw_gold_pillar",
                PillarBlock::new, (Settings.copy(Blocks.RAW_GOLD_BLOCK)));
    ...
    private static Block registerBlock(String name, Block block) {
        RegistryKey<Block> blockKey = RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(BetterBuilding.MOD_ID, name));
        Function<Settings, Block> function = (settings) -> block;
        Block blockWithKey = new Block(Settings.copy(block).registryKey(blockKey));
        //block.getSettings().registryKey(blockKey);
        //block = function.apply(block.getSettings().registryKey(blockKey));
        registerBlockItem(name, block);
        return Registry.register(Registries.BLOCK, blockKey, blockWithKey);
    }
