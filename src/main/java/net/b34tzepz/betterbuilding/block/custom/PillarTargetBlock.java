...
public class PillarTargetBlock extends PillarBlock {
    private static final IntProperty POWER = Properties.POWER;

    public PillarTargetBlock(Settings settings) {
        super(settings);
        this.setDefaultState(this.stateManager.getDefaultState().with(AXIS, Direction.Axis.Y).with(POWER, 0).with(WATERLOGGED, false));
    }
    ...
    protected void appendProperties(StateManager.Builder<Block, BlockState> builder) {
        builder.add(AXIS, POWER, WATERLOGGED);
    }
