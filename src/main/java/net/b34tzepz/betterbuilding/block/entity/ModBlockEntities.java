...
public class ModBlockEntities {
    ...
    public static void registerAllEntities() {
        OAK_CHAIR = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(BetterBuilding.MOD_ID, "oak_chair"),
                FabricBlockEntityTypeBuilder.create(ChairEntity::new,
                        ModBlocks.OAK_CHAIR).build(null));


        TELEPORTER_BLOCK = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(BetterBuilding.MOD_ID, "teleporter_block"),
                FabricBlockEntityTypeBuilder.create(TeleporterBlockEntity::new,
                        ModBlocks.TELEPORTER_BLOCK).build(null));

        FABRICATOR_BLOCK = Registry.register(Registries.BLOCK_ENTITY_TYPE, new Identifier(BetterBuilding.MOD_ID, "fabricator"),
