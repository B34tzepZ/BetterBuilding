...
public class ChiselItem extends Item {
        public static final Map<Block, BlockState> PILLAR_STATES = Maps.newHashMap(new ImmutableMap.Builder<Block, BlockState>()
                ...
                .put(Blocks.MUD, ModBlocks.Pillars.MUD_PILLAR.getDefaultState())
                .put(Blocks.COBBLESTONE, ModBlocks.Pillars.COBBLESTONE_PILLAR.getDefaultState())
                .put(Blocks.OAK_PLANKS, ModBlocks.Pillars.OAK_PLANK_PILLAR.getDefaultState())
                .put(Blocks.SPRUCE_PLANKS, ModBlocks.Pillars.SPRUCE_PLANK_PILLAR.getDefaultState())
                .put(Blocks.BIRCH_PLANKS, ModBlocks.Pillars.BIRCH_PLANK_PILLAR.getDefaultState())
                .put(Blocks.JUNGLE_PLANKS, ModBlocks.Pillars.JUNGLE_PLANK_PILLAR.getDefaultState())
                .put(Blocks.ACACIA_PLANKS, ModBlocks.Pillars.ACACIA_PLANK_PILLAR.getDefaultState())
                .put(Blocks.DARK_OAK_PLANKS, ModBlocks.Pillars.DARK_OAK_PLANK_PILLAR.getDefaultState())
                ...
                .put(Blocks.BRICKS, ModBlocks.Pillars.BRICK_PILLAR.getDefaultState())
                ...
                .put(Blocks.STONE_BRICKS, ModBlocks.Pillars.STONE_BRICK_PILLAR.getDefaultState())
                .put(Blocks.MOSSY_STONE_BRICKS, ModBlocks.Pillars.MOSSY_STONE_BRICK_PILLAR.getDefaultState())
                .put(Blocks.CRACKED_STONE_BRICKS, ModBlocks.Pillars.CRACKED_STONE_BRICK_PILLAR.getDefaultState())
                .put(Blocks.CHISELED_STONE_BRICKS, ModBlocks.Pillars.CHISELED_STONE_BRICK_PILLAR.getDefaultState())
                .put(Blocks.PACKED_MUD, ModBlocks.Pillars.PACKED_MUD_PILLAR.getDefaultState())
                .put(Blocks.MUD_BRICKS, ModBlocks.Pillars.MUD_BRICK_PILLAR.getDefaultState())
                .put(Blocks.NETHER_BRICKS, ModBlocks.Pillars.NETHER_BRICK_PILLAR.getDefaultState())
                ...
                .put(Blocks.PRISMARINE_BRICKS, ModBlocks.Pillars.PRISMARINE_BRICK_PILLAR.getDefaultState())
                ...
                .put(Blocks.END_STONE_BRICKS, ModBlocks.Pillars.END_STONE_BRICK_PILLAR.getDefaultState())
                .put(Blocks.NETHER_WART_BLOCK, ModBlocks.Pillars.NETHER_WART_BLOCK_PILLAR.getDefaultState())
                .put(Blocks.RED_NETHER_BRICKS, ModBlocks.Pillars.RED_NETHER_BRICK_PILLAR.getDefaultState())
                ...
                .put(Blocks.CRIMSON_PLANKS, ModBlocks.Pillars.CRIMSON_PLANK_PILLAR.getDefaultState())
                .put(Blocks.WARPED_PLANKS, ModBlocks.Pillars.WARPED_PLANK_PILLAR.getDefaultState())
                ...
                .put(Blocks.POLISHED_BLACKSTONE_BRICKS, ModBlocks.Pillars.POLISHED_BLACKSTONE_BRICK_PILLAR.getDefaultState())
                .put(Blocks.CRACKED_POLISHED_BLACKSTONE_BRICKS, ModBlocks.Pillars.CRACKED_POLISHED_BLACKSTONE_BRICK_PILLAR.getDefaultState())
                ...
                .put(Blocks.CHISELED_NETHER_BRICKS, ModBlocks.Pillars.CHISELED_NETHER_BRICK_PILLAR.getDefaultState())
                .put(Blocks.CRACKED_NETHER_BRICKS, ModBlocks.Pillars.CRACKED_NETHER_BRICK_PILLAR.getDefaultState())
                .put(Blocks.QUARTZ_BRICKS, ModBlocks.Pillars.QUARTZ_BRICK_PILLAR.getDefaultState())
                ...
                .put(Blocks.DEEPSLATE_TILES, ModBlocks.Pillars.DEEPSLATE_TILE_PILLAR.getDefaultState())
                .put(Blocks.DEEPSLATE_BRICKS, ModBlocks.Pillars.DEEPSLATE_BRICK_PILLAR.getDefaultState())
                .put(Blocks.CHISELED_DEEPSLATE, ModBlocks.Pillars.CHISELED_DEEPSLATE_PILLAR.getDefaultState())
                .put(Blocks.CRACKED_DEEPSLATE_BRICKS, ModBlocks.Pillars.CRACKED_DEEPSLATE_BRICK_PILLAR.getDefaultState())
                .put(Blocks.CRACKED_DEEPSLATE_TILES, ModBlocks.Pillars.CRACKED_DEEPSLATE_TILE_PILLAR.getDefaultState())
